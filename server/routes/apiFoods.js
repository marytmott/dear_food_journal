...
router.post('/search', function(req, res) {
  ...
  var apiSearchLink = 'https://api.nutritionix.com/v1_1/search/'
    + userSearch + '?results=0:20&fields=item_name,brand_name,item_id,nf_calories,nf_serving_size_qty,nf_serving_size_unit,nf_total_fat,nf_total_carbohydrate,nf_dietary_fiber&appId='
    + appId + '&appKey=' + apiKey;
